...
const StoryModel = ({setShowModel, fetchStories}) => {
    ...
    const bgColors = ["#6366F1","#A855F7","#EC4899","#F43F5E","#0EA5E9","#10B981","#F59E0B"]
    ...
    <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur
     text-white flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
            ...
            <div className='rounded-lg h-96 flex items-center 
            justify-center relative' style={{backgroundColor: background}}>
                ...
                <div className='flex gap-2 mt-4'>
                    ...
                    <label className={`flex-1 flex items-center justify-center 
                        gap-2 p-2 rounded cursor-pointer ${mode === 'media' ? 
                        "bg-gradient-to-r from-blue-600 to-indigo-700 text-white" : 
                        "bg-zinc-800 text-green-400"}`}>
                        <input onChange={(e) =>{handleMediaUpload(e); 
                        setMode('media')}} type='file' accept='image/*, video/*' className='hidden'/>
                ...
                rounded bg-gradient-to-r from-indigo-500 to-purple-6 hover:from-indigo-600
